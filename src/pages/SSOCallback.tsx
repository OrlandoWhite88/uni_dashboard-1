...
/**
 * SSO callback handler component for Clerk authentication
 */
const SSOCallback = () => {
  ...
  useEffect(() => {
    // Process the Clerk SSO callback
    const processCallback = async () => {
      try {
        // Let Clerk handle the redirect callback
        // This automatically processes the SSO flow and redirects based on your ClerkProvider configuration
