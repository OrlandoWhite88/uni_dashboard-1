...
const BatchClassify = ({ csvFile }: { csvFile: string | ArrayBuffer }) => {
  ...
  const products = useMemo(() => {
    const splittedProducts = csvFile.toString().split("\n");
    const title = splittedProducts.splice(0, 1);
    return _.compact(splittedProducts).map((value, i) => {
      ...
      <div className="max-w-4xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">
            Answer a few questions about your products to get accurate HS code
