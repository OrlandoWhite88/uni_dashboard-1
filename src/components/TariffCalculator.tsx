...
export const COUNTRIES = [
  ...
  { code: "AX", name: "Åland Islands", ntr: true, gsp: false },
  ...
  { code: "AQ", name: "Antarctica", ntr: true, gsp: false },
  { code: "AG", name: "Antigua and Barbuda", ntr: true, gsp: false },
  ...
  { code: "BD", name: "Bangladesh", ntr: true, gsp: false },
  { code: "BB", name: "Barbados", ntr: true, gsp: false },
  { code: "BY", name: "Belarus", ntr: false, gsp: false },
  ...
  { code: "BO", name: "Bolivia, Plurinational State of", ntr: true, gsp: true },
  { code: "BQ", name: "Bonaire, Sint Eustatius and Saba", ntr: true, gsp: false },
  { code: "BA", name: "Bosnia and Herzegovina", ntr: true, gsp: true },
  { code: "BW", name: "Botswana", ntr: true, gsp: true },
  { code: "BV", name: "Bouvet Island", ntr: true, gsp: false },
  { code: "BR", name: "Brazil", ntr: true, gsp: true },
  { code: "IO", name: "British Indian Ocean Territory", ntr: true, gsp: true },
  { code: "BN", name: "Brunei Darussalam", ntr: true, gsp: false },
  ...
  { code: "CV", name: "Cabo Verde", ntr: true, gsp: true },
  ...
  { code: "CX", name: "Christmas Island", ntr: true, gsp: true },
  { code: "CC", name: "Cocos (Keeling) Islands", ntr: true, gsp: true },
  { code: "CO", name: "Colombia", ntr: true, gsp: false },
  { code: "KM", name: "Comoros", ntr: true, gsp: true },
  { code: "CG", name: "Congo", ntr: true, gsp: true },
  { code: "CD", name: "Congo, Democratic Republic of the", ntr: true, gsp: true },
  ...
  { code: "CU", name: "Cuba", ntr: false, gsp: false },
  { code: "CW", name: "Curaçao", ntr: true, gsp: false },
  { code: "CY", name: "Cyprus", ntr: true, gsp: false },
  { code: "CZ", name: "Czechia", ntr: true, gsp: false },
  ...
  { code: "GQ", name: "Equatorial Guinea", ntr: true, gsp: false },
  ...
  { code: "FK", name: "Falkland Islands (Malvinas)", ntr: true, gsp: true },
  ...
  { code: "TF", name: "French Southern Territories", ntr: true, gsp: false },
  ...
  { code: "HM", name: "Heard Island and McDonald Islands", ntr: true, gsp: true },
  { code: "VA", name: "Holy See", ntr: true, gsp: false },
  ...
  { code: "IN", name: "India", ntr: true, gsp: false },
  { code: "ID", name: "Indonesia", ntr: true, gsp: true },
  { code: "IR", name: "Iran, Islamic Republic of", ntr: true, gsp: false },
  ...
  { code: "JO", name: "Jordan", ntr: true, gsp: true },
  { code: "KZ", name: "Kazakhstan", ntr: true, gsp: true },
  { code: "KE", name: "Kenya", ntr: true, gsp: true },
  { code: "KI", name: "Kiribati", ntr: true, gsp: true },
  { code: "KP", name: "Korea, Democratic People's Republic of", ntr: false, gsp: false },
  { code: "KR", name: "Korea, Republic of", ntr: true, gsp: false },
  { code: "KW", name: "Kuwait", ntr: true, gsp: false },
  { code: "KG", name: "Kyrgyzstan", ntr: true, gsp: true },
  { code: "LA", name: "Lao People's Democratic Republic", ntr: true, gsp: false },
  ...
  { code: "LY", name: "Libya", ntr: true, gsp: false },
  ...
  { code: "MH", name: "Marshall Islands", ntr: true, gsp: false },
  ...
  { code: "FM", name: "Micronesia, Federated States of", ntr: true, gsp: false },
  { code: "MD", name: "Moldova, Republic of", ntr: true, gsp: true },
  ...
  { code: "NR", name: "Nauru", ntr: true, gsp: false },
  { code: "NP", name: "Nepal", ntr: true, gsp: true },
  { code: "NL", name: "Netherlands, Kingdom of the", ntr: true, gsp: false },
  ...
  { code: "PW", name: "Palau", ntr: true, gsp: false },
  { code: "PS", name: "Palestine, State of", ntr: true, gsp: true },
  ...
  { code: "PN", name: "Pitcairn", ntr: true, gsp: true },
  ...
  { code: "RU", name: "Russian Federation", ntr: false, gsp: false },
  { code: "RW", name: "Rwanda", ntr: true, gsp: true },
  { code: "BL", name: "Saint Barthélemy", ntr: true, gsp: false },
  { code: "SH", name: "Saint Helena, Ascension and Tristan da Cunha", ntr: true, gsp: true },
  { code: "KN", name: "Saint Kitts and Nevis", ntr: true, gsp: false },
  { code: "LC", name: "Saint Lucia", ntr: true, gsp: true },
  { code: "MF", name: "Saint Martin (French part)", ntr: true, gsp: false },
  ...
  { code: "GS", name: "South Georgia and the South Sandwich Islands", ntr: true, gsp: false },
  { code: "SS", name: "South Sudan", ntr: true, gsp: true },
  { code: "ES", name: "Spain", ntr: true, gsp: false },
  { code: "LK", name: "Sri Lanka", ntr: true, gsp: true },
  { code: "SD", name: "Sudan", ntr: true, gsp: false },
  { code: "SR", name: "Suriname", ntr: true, gsp: true },
  { code: "SJ", name: "Svalbard and Jan Mayen", ntr: true, gsp: false },
  { code: "SE", name: "Sweden", ntr: true, gsp: false },
  { code: "CH", name: "Switzerland", ntr: true, gsp: false },
  { code: "SY", name: "Syrian Arab Republic", ntr: true, gsp: false },
  { code: "TW", name: "Taiwan, Province of China", ntr: true, gsp: false },
  { code: "TJ", name: "Tajikistan", ntr: true, gsp: false },
  { code: "TZ", name: "Tanzania, United Republic of", ntr: true, gsp: true },
  ...
  { code: "TT", name: "Trinidad and Tobago", ntr: true, gsp: false },
  { code: "TN", name: "Tunisia", ntr: true, gsp: true },
  { code: "TR", name: "Türkiye", ntr: true, gsp: false },
  { code: "TM", name: "Turkmenistan", ntr: true, gsp: false },
  ...
  { code: "GB", name: "United Kingdom of Great Britain and Northern Ireland", ntr: true, gsp: false },
  { code: "US", name: "United States of America", ntr: true, gsp: false },
  { code: "UM", name: "United States Minor Outlying Islands", ntr: true, gsp: false },
  { code: "UY", name: "Uruguay", ntr: true, gsp: false },
  { code: "UZ", name: "Uzbekistan", ntr: true, gsp: true },
  { code: "VU", name: "Vanuatu", ntr: true, gsp: true },
  { code: "VE", name: "Venezuela, Bolivarian Republic of", ntr: true, gsp: false },
  { code: "VN", name: "Viet Nam", ntr: true, gsp: false },
  { code: "VG", name: "Virgin Islands (British)", ntr: true, gsp: true },
  { code: "VI", name: "Virgin Islands (U.S.)", ntr: true, gsp: false },
  { code: "WF", name: "Wallis and Futuna", ntr: true, gsp: true },
  { code: "EH", name: "Western Sahara", ntr: true, gsp: true },
